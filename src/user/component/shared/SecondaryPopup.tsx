...
export default function SecondaryPopup({
  ...
  return (
    <div
      data-testid="secondary-popup-bg"
      className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-fit h-fit flex flex-col justify-center items-center bg-gray-100 z-[100] border border-cyan-700 rounded-lg shadow-xl"
    >
